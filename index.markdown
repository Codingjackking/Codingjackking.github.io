    ...
    <div class="sidebar-content">
      ...
      <p>
        ...
        <span class="cg-contact"
              data-cg-type="link"
              data-cg-value="JmV3YQZjYQpfAFj0APj5ZFj3ZPjkZGVfBQRfBGHfBQLfBGVfZwxfZGZfZwHfZwNfAwNfZGNfZvj1APj5Zvj4AljlBPj4ZvjlAvjmZPjlAljjYQLkYQp5YQNfAQuq"
              data-cg-label="codingjackking.github.io"
              tabindex="0"
              aria-label="Website — hover to reveal">
          [hover to reveal]
        </span>
      </p>
      <p>
        ...
        <span class="cg-contact"
              data-cg-type="email"
              data-cg-value="JmV5YQRkYQV2YQV3YQH2YQxfZwxfAGtfAmNfZFjjYQLfAGRfZGZfZmNfZwNfAGDfZGZfAmRfAwNfBGZfBGAq"
      ...
      <p>
        ...
        <span class="cg-contact"
              data-cg-type="link"
              data-cg-value="JmV3YQZjYQpfAFj0APj5ZFj3ZPjkZGVfBGDfBQxfBGVfBGDfZwVfZGDfZwLfZwpfZGRmYQVfAvj1ZPjlBFj4BFj5ZvjlAvjlBFjkZFjlAvjlAlj1Avj5YQV5YQH4YQpjKD=="
              data-cg-label="LinkedIn"
              tabindex="0"
              aria-label="LinkedIn — hover to reveal">
          [hover to reveal]
        </span>
      </p>
      <p>
        ...
        <span class="cg-contact"
              data-cg-type="link"
              data-cg-value="JmV3YQZjYQpfAFj0APj5ZFj3ZPjkZGVfBQHfBQxfAmNfBGZfAvj4YQxmYQVlYQD4YQRlYQpjYQV4YQxmYQt0YQxkYQxkYQVjYQNfZGtfZwVfAGVfZGNfZPj0BFj4AI0="
              data-cg-label="GitHub"
              tabindex="0"
              aria-label="GitHub — hover to reveal">
          [hover to reveal]
        </span>
      </p>
    </div>
